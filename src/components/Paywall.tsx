      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-semibold text-gray-900">¡Tu negocio está listo!</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
              ...
              {selectedPlan === 'monthly' && (
                <div className="border-2 border-blue-500 bg-blue-50 rounded-xl p-6">
                  <div className="text-center mb-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Plan Mensual</h3>
                    <div className="mb-3">
                      <span className="text-4xl font-bold text-gray-900">$275</span>
              ...
              {selectedPlan === 'yearly' && (
                <div className="border-2 border-green-500 bg-green-50 rounded-xl p-6">
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Plan Anual</h3>
                    <div className="mb-2">
                      <span className="text-4xl font-bold text-gray-900">$2,750</span>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 text-white text-center">
          ...
          <button 
            onClick={handleStartTrial}
            disabled={isLoading || stripeLoading}
            className="bg-white text-blue-600 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold transition-colors inline-flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <CreditCard className="w-4 h-4" />
